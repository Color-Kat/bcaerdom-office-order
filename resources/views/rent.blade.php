        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <p>
                        Если Вы ищете отличное место для аренды офиса в центральном районе Москвы, культурно-деловой комплекс «Большевик» станет для Вас отличным выбором. Мы сможем предложить различные варианты аренды свободных площадей в зависимости от Ваших потребностей.
                    </p>

                    <p>
                        Площадь арендуемых помещений составляет 80 000 м2, реализуются помещения от 300 до 15000 м2. Территория, на которой располагается бизнес-центр, насчитывает 6 га. Планировка офисных помещений – открытого типа, что позволит максимально эффективно организовать рабочее пространство с учетом специфики деятельности компании, создать эксклюзивный интерьер с собственной деловой атмосферой.
                    </p>

                    <p>
                        Ставка за метр в год складывается в зависимости от характеристик арендуемого помещения. Для получения более детальной информации об аренде офисов в данном культурно-деловом комплексе, звоните нам по телефону или оставляйте заявку на нашем сайте.
                    </p>
                </div>
            </div>
        </div>
