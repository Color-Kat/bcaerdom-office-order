        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <p>
                        Бизнес-центр «Port Plaza» обладает всеми необходимыми характеристиками современного высококлассного офисного центра, чтобы стать отличным выбором для Вас. Для тех, кто сделал свой выбор в пользу данного бизнес-центра, мы можем предложить различные варианты аренды вакантных площадей.
                    </p>

                    <p>
                        В бизнес-центре Port Plaza доступны к аренде офисы открытого типа, что позволит арендаторам максимально эффективно организовать рабочее пространство с учетом специфики деятельности компании. Помещения предоставляются в состоянии «под отделку».
                    </p>

                    <p>
                        Ставка за метр в год соответствуйет классу, коммунальные платежи оплачиваются отдельно. Тип договора аренды, депозит и условия платежей обсуждаются.
                    </p>
                </div>
            </div>
        </div>
