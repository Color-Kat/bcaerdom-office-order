@extends('main')
@section('title', 'Продажа офиса в бизнес-центре Северное Сияние')
@section('content')
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <p>
                        Если Вы хотите приобрести помещение в бизнес-центре класса «А» в Савеловском районе Москвы, престижный и комфортный для работы БЦ «Северное Сияние» станет для Вас отличным выбором.
                    </p>

                    <p>
                        В данном бизнес-центре доступны к продаже офисные блоки площадью от 177 м2 со смешанном типом планировки, позволяющим максимально эффективно организовать рабочее пространство. Также имеются открытые этажи площадью до 3517 м2 . Офисы с высококачественным ремонтом полностью готовы к въезду.
                    </p>

                    <p>
                        Для получения более конкретной информации об аренде офисов в бизнес-центре «Северное Сияние», звоните нам по телефону или оставляйте заявку на нашем сайте.
                    </p>
                </div>
            </div>
        </div>
