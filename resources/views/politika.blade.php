    ...
    <div id="inputResult" style="width: 80%;margin:auto;padding-top: 120px;padding-bottom: 30px">
            ...
            <div class="col">
                ...
                <div class="descr">
                    ...
                    данных, предпринимаемые <span class="link mark owner-name-field" id="owner-name-value"
                                                  data-scroll-to="#owner-name-field">бизнес-центра Аэродом</span> (далее&nbsp;—
                    Оператор).
                </div>
                <div class="ol">
                    <div class="li">
        ...
        <div class="row mb-4">
            <div class="col">
                ...
                <div class="ol">
                    <div class="li" id="0KObp">
                        <table class="purpose-table">
                            <tbody>
                            <tr>
                                <th>Цель обработки</th>
                                <td class="purpose-field"><span class="mark link">информирование Пользователя посредством отправки электронных писем</span>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="legal-field">
                                    <ul>
                                        <li><span class="mark link">уставные (учредительные) документы Оператора</span>
                                        </li>
                                    </ul>
                                </td>
                            </tr>
                ...
                <div class="ol">
                    ...
                    <div class="li">
                        ...
                        в&nbsp;сети Интернет по&nbsp;адресу <span id="owner-privacy-url-value"
                                                                  ...
                                                                  data-scroll-to="#owner-privacy-url-field">https://thismywebsite.com/privacy/</span>.
                    </div>
                </div>
            </div>
        </div>
