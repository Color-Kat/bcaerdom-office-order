                                            ...
                                            <div class="onoffswitch">
                                                ...
                                                @if ($data->flag_header == 1)
                                                    <input type="checkbox" name="
                                                           ...
                                                           onclick="f1('flag_header',0, '{{ csrf_token() }}')" checked>

                                                @else
                                                    <input type="checkbox" name="
                                                                                            collapsemenu"
                                                           class="onoffswitch-checkbox" id="example1"
                                                           onclick="f1('flag_header',1, '{{ csrf_token() }}')">
                                            ...
                                            <div class="onoffswitch">
                                                @if ($data->flag_footer == 1)
                                                    <input type="checkbox" name="
                                                           ...
                                                           onclick="f1('flag_footer', 0, '{{ csrf_token() }}')" checked>

                                                @else
                                                    <input type="checkbox" name="
                                                                                            collapsemenu"
                                                           class="onoffswitch-checkbox" id="example2"
                                                           onclick="f1('flag_footer',1, '{{ csrf_token() }}')">
                                            ...
                                            <div class="onoffswitch">
                                                @if ($data->flag_sign == 1)
                                                    <input type="checkbox" name="
                                                           ...
                                                           onclick="f1('flag_sign',0, '{{ csrf_token() }}')" checked>

                                                @else
                                                    <input type="checkbox" name="
                                                                                            collapsemenu"
                                                           class="onoffswitch-checkbox" id="example3"
                                                           onclick="f1('flag_sign',1, '{{ csrf_token() }}')">
